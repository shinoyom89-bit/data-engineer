...
This folder defines all source code for the 'News_dlt_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_news_dlt_pipeline.py" to get familiar with the syntax.
